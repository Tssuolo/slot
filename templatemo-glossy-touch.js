let currentPage = 'home';
        ...
        // 데모 카드(검색 대상)만 선택: .features.rest-features 중에서 .banner-section은 제외
...
function showDemoPage(page) {
  ...
  const topPagination = document.getElementById("demo-pagination-top");
  const bottomPagination = document.getElementById("demo-pagination");
  if (topPagination) renderPagination(topPagination);
  if (bottomPagination) renderPagination(bottomPagination);
}
  }
